...
import { Loader2, Plus, Image, Upload, Laptop, Monitor, Keyboard, X, Cloud } from "lucide-react";
...
const categoryInfo = {
  laptops: { icon: Laptop, label: 'Laptop', color: 'bg-blue-500/10 text-blue-500 border-blue-500/30' },
  desktops: { icon: Monitor, label: 'Desktop', color: 'bg-purple-500/10 text-purple-500 border-purple-500/30' },
  accessories: { icon: Keyboard, label: 'Accessory', color: 'bg-green-500/10 text-green-500 border-green-500/30' },
};
        ...
        <DialogHeader className="px-4 sm:px-6 pt-4 sm:pt-6 pb-4 border-b border-border/30">
          <DialogTitle className="text-lg sm:text-xl font-bold flex items-center gap-3">
            ...
            <div>
              ...
              {productName && (
                <p className="text-sm font-normal text-muted-foreground mt-0.5 truncate max-w-[200px]">
                  {productName}
                </p>
              )}
            </div>
            ...
            <div className="px-4 sm:px-6 py-4 space-y-5">
                ...
                <div className="grid grid-cols-3 gap-2 sm:gap-3">
                  {(Object.keys(categoryInfo) as Array<keyof typeof categoryInfo>).map((cat) => {
                    ...
                    return (
                      ...
                      >
                        <Icon className={`w-5 h-5 sm:w-6 sm:h-6 mx-auto mb-1.5 ${isSelected ? 'text-primary' : 'text-muted-foreground'}`} />
              ...
              <Tabs value={activeTab} onValueChange={setActiveTab}>
                ...
                <TabsContent value="basic" className="space-y-4 mt-4">
                  ...
                  {isAccessory && (
                    <div className="space-y-2">
                      <Label className="text-sm">Accessory Name <span className="text-destructive">*</span></Label>
                      <Input
                        value={formData.name}
