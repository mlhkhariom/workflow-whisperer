...
export function ChatWindow({ contactId, contact }: ChatWindowProps) {
  ...
  return (
    <div className="flex-1 flex bg-gradient-to-br from-background via-background to-card/30">
      {/* Main Chat Area */}
      ...
      {showSidebar && (
        <div className="w-72 border-l border-border/50 bg-card/30 backdrop-blur-sm p-4 space-y-6 animate-fade-in overflow-y-auto">
          {/* Contact Tags */}
